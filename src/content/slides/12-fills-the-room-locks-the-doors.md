---
title: "Fills the room / locks the doors"
...
This slide's job is to break a habit of hearing, not to add a doctrine. Project it when you reach verse 3, and then do the one thing it licenses: read the two halves as two claims and name them as you go — first the scope, then the exclusivity. Say the first half and let your hearers see how far it reaches. Then say the second, and let them hear the doors close. In a classroom the same slide is a question rather than a statement: ask what the second half adds, let the room try to answer from the first half alone, and watch it fail. The restraint: don't turn it into a lesson on the Greek, and don't press the third door into a quarrel with anyone in particular — the point is what the sentence shuts, not whom it was aimed at. One sentence is the whole move: *teach the two halves as two claims — scope, then exclusivity.*
