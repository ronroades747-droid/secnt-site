...
This slide's job is to dissolve a defensive posture, not to prove a doctrine. Project it when the "three in one" question surfaces and let the headline reframe the question before you answer anything: the doctrine's starting point is a relationship, not a sum. The gold line hands your hearers the verse so the claim rests on the text, not on you. The restraint: don't diagram, don't count, don't explain the Greek from the front — say *with*, say *face to face*, and let the image do its own work: the unending love, and the family it made. One sentence is the whole move: *God did not need you, and loves you still — and that is better news, not worse.*
